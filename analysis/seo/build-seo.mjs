...
const SERIES_LANDING_CONFIG = {
  comfort: {
    ...
    intro:
      "Сюда удобнее идти, когда кожа быстро теряет комфорт, шелушится, реагирует на сухой воздух и просит более плотной поддержки без тяжёлого ощущения маски.",
    firstStep:
  ...
  balance: {
    ...
    intro:
      "Сюда удобно идти, когда хочется уменьшить жирный блеск и ощущение перегруза, но не превратить уход в жёсткое матирование, после которого кожа только сильнее реагирует.",
    firstStep:
  ...
  male: {
    ...
    intro:
      "Сюда стоит идти с понятным повседневным сценарием: кожа после бритья краснеет, сохнет или просто требует спокойного кремового ухода без сложной многоступенчатой схемы.",
    firstStep:
  ...
  tonics: {
    ...
    intro:
      "Сюда лучше идти тем, кто не хочет пропускать водный этап ухода: после умывания быстрее вернуть коже комфорт, подготовить её к крему и выбрать гидролат или тоник под свой сценарий.",
    firstStep:
  ...
  renewal: {
    ...
    intro:
      "Сюда стоит идти, когда нужен аккуратный чистый старт: убрать загрязнения, снизить ощущение шероховатости и подготовить кожу к крему без агрессивного очищения.",
    firstStep:
    ...
    intro:
      "Сюда удобнее идти с очень понятной задачей: сухие руки, губы, трещины, пятки и участки, которым нужен быстрый комфорт без сложной схемы ухода.",
    firstStep:
          ...
          <div class="page-hero__grid">
            <div class="page-hero__copy">
              ...
              <div class="button-row">
                ...
                <a class="button button_secondary" href="${escapeHtml(productFile(lead[0]))}">Посмотреть пример средства</a>
              </div>
            </div>
      ...
      <section class="section section_tinted">
        <div class="container">
          <div class="section-head">
            ...
            <h2>С этих средств обычно проще всего начать знакомство с направлением</h2>
            <p>
              Ниже собраны средства, через которые удобнее перейти к конкретной формуле,
              цене и способу применения без лишнего перебора.
            </p>
          </div>
          <div class="mini-grid">
      ...
      <section class="section">
        <div class="container">
          <div class="section-head">
            ...
            <h2>То, что обычно хочется понять ещё до открытия карточки товара</h2>
          </div>
